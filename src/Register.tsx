...
const RegisterPage = () => {
    ...
    const registerStudio = async (e: any) => {
        // 1. Prevents the browser from refreshing the page
        e.preventDefault();
        ...
        <main className="max-w-5xl mx-auto px-4 py-12 md:py-20">
            ...
            <section className="max-w-md mx-auto bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                ...
                <div className="p-8 border-b border-slate-100 text-center">
                    ...
                    <h2 className="text-2xl font-black text-slate-800">Register</h2>
                    <p className="text-sm text-slate-500 mt-1">Create your Profile</p>
                </div>
                ...
                <form className="p-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            type="email"
                            placeholder="george_clooney56@barber.com"
                            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-200 focus:border-slate-400 transition-all"
                            value={email}
                ...
                <div className="p-6 bg-slate-50 border-t border-slate-100 text-center">
                    <p className="text-sm text-slate-600">
                        <Link to="/get-in" className="text-blue-600 font-bold hover:underline">Login</Link>
                    </p>
                </div>
            </section>
        </main>
